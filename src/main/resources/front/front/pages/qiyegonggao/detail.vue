	...
	<view class="content">
		<view class="container" :style='{"padding":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"100%"}'>
				...
				<view :style='{"margin":"0 0 12rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}' class="detail-list-item title">
					<view :style='{"padding":"0 10rpx 0 0","color":"#424EF0","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}' class="lable">标题：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#666","flex":"1"}' class="text">{{detail.biaoti}}</view>
				</view>
				<view :style='{"margin":"0 0 12rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}' class="detail-list-item title">
				...
				<view class="detail-list-item" :style='{"margin":"0 0 12rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}'>
					<view class="lable" :style='{"padding":"0 10rpx 0 0","color":"#424EF0","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>简介：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#666","flex":"1"}'>{{detail.jianjie}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"0 0 24rpx 0","borderColor":"#ccc","color":"#000","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}'>
					<view class="lable" :style='{"padding":"0 10rpx 0 0","color":"#424EF0","textAlign":"right","display":"block","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>内容：</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"10rpx 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"center","height":"auto","order":"8"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 8rpx","color":"#fff","borderRadius":"10rpx","background":"#424EF0","width":"calc(25% - 20rpx)","fontSize":"26rpx","height":"60rpx"}' v-if="userid&&isAuth('qiyegonggao','审核')" @tap="onSHTap">审核</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 8rpx","color":"#fff","borderRadius":"10rpx","background":"#424EF0","width":"calc(25% - 20rpx)","fontSize":"26rpx","height":"60rpx"}' v-if="!userid&&isAuthFront('qiyegonggao','审核')" @tap="onSHTap">审核</button>
	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('qiyegonggao', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','qiyegonggao');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('qiyegonggao',_this.detail)
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','qiyegonggao');
			...
			async init(type=1){
				...
				let res = await this.$api.info('qiyegonggao', this.id);
				this.detail = res.data;
				...
				if(type==2){
					...
					await this.$api.update('qiyegonggao',this.detail)
				}
			},
