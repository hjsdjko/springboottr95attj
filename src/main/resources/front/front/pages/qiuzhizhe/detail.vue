...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"padding":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"100%"}'>
				...
				<view class="detail-list-item" :style='{"margin":"0 0 12rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}'>
					<view class="lable" :style='{"padding":"0 10rpx 0 0","color":"#424EF0","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>年龄：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#666","flex":"1"}'>{{detail.nianling}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"0 0 12rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}'>
				...
				<view class="detail-list-item" :style='{"margin":"0 0 12rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}'>
					...
					<view style="text-decoration: underline" @tap="callClick(detail.shouji)"  class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#666","flex":"1"}'>{{detail.shouji}}</view>
				</view>
	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('qiuzhizhe', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','qiuzhizhe');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','qiuzhizhe');
			...
			async init(type=1){
				...
				let res = await this.$api.info('qiuzhizhe', this.id);
				this.detail = res.data;
				...
				if(type==2){
					...
					await this.$api.update('qiuzhizhe',this.detail)
				}
			},
