			...
			<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
				<view class="uni-product-list" :style='{"padding":"24rpx","margin":"0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					<view @tap="onDetailTap(product)" class="uni-product" :style='{"boxShadow":"none","margin":"0 0 20rpx","backgroundColor":"#fff","flexWrap":"wrap","display":"flex","width":"48%","height":"auto"}' v-for="(product,index) in list" :key="index">
						<view class="uni-product-title " :style='{"padding":"4rpx 20rpx","color":"#000","width":"100%","lineHeight":"1.4","fontSize":"28rpx","fontWeight":"bold","order":"2"}'>{{product.name}}</view>
						<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"10rpx","display":"block","width":"100%","height":"300rpx","order":"1"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.picture)" :src="product.picture"></image>
						<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"10rpx","display":"block","width":"100%","height":"300rpx","order":"1"}' mode="aspectFill" class="uni-product-image" v-else :src="baseUrl+product.picture"></image>
					</view>
				</view>
