	...
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#666","borderRadius":"0 0 10px 10px","background":"#fff","width":"calc(100% - 60px)","fontSize":"16px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="求职意向" prop="qiuzhiyixiang">
					<el-input v-model="ruleForm.qiuzhiyixiang" placeholder="求职意向" clearable  :readonly="ro.qiuzhiyixiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="求职意向" prop="qiuzhiyixiang">
					<el-input v-model="ruleForm.qiuzhiyixiang" placeholder="求职意向" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="意向职位" prop="yixiangzhiwei">
					<el-input v-model="ruleForm.yixiangzhiwei" placeholder="意向职位" clearable  :readonly="ro.yixiangzhiwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="意向职位" prop="yixiangzhiwei">
					<el-input v-model="ruleForm.yixiangzhiwei" placeholder="意向职位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="意向城市" prop="yixiangchengshi">
					<el-input v-model="ruleForm.yixiangchengshi" placeholder="意向城市" clearable  :readonly="ro.yixiangchengshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="意向城市" prop="yixiangchengshi">
					<el-input v-model="ruleForm.yixiangchengshi" placeholder="意向城市" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="薪资要求" prop="xinziyaoqiu">
					<el-input v-model="ruleForm.xinziyaoqiu" placeholder="薪资要求" clearable  :readonly="ro.xinziyaoqiu"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="薪资要求" prop="xinziyaoqiu">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="工作经验" prop="gongzuojingyan">
					<el-input
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.gongzuojingyan" label="工作经验" prop="gongzuojingyan">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.gongzuojingyan}}</span>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="自我评价" prop="ziwopingjia">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.ziwopingjia" label="自我评价" prop="ziwopingjia">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.ziwopingjia}}</span>
				</el-form-item>
