	...
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#666","borderRadius":"0 0 10px 10px","background":"#fff","width":"calc(100% - 60px)","fontSize":"16px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="学历" prop="xueli">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="求职岗位" prop="qiuzhigangwei">
					<el-input v-model="ruleForm.qiuzhigangwei" placeholder="求职岗位" clearable  :readonly="ro.qiuzhigangwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="求职岗位" prop="qiuzhigangwei">
					<el-input v-model="ruleForm.qiuzhigangwei" placeholder="求职岗位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="期望薪资" prop="qiwangxinzi">
					<el-input v-model="ruleForm.qiwangxinzi" placeholder="期望薪资" clearable  :readonly="ro.qiwangxinzi"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="期望薪资" prop="qiwangxinzi">
					<el-input v-model="ruleForm.qiwangxinzi" placeholder="期望薪资" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="获奖证书" prop="huojiangzhengshu">
					<el-input v-model="ruleForm.huojiangzhengshu" placeholder="获奖证书" clearable  :readonly="ro.huojiangzhengshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="获奖证书" prop="huojiangzhengshu">
					<el-input v-model="ruleForm.huojiangzhengshu" placeholder="获奖证书" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="毕业学校" prop="biyexuexiao">
					<el-input v-model="ruleForm.biyexuexiao" placeholder="毕业学校" clearable  :readonly="ro.biyexuexiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="毕业学校" prop="biyexuexiao">
					<el-input v-model="ruleForm.biyexuexiao" placeholder="毕业学校" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="企业账号" prop="qiyezhanghao">
					<el-input v-model="ruleForm.qiyezhanghao" placeholder="企业账号" clearable  :readonly="ro.qiyezhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="企业账号" prop="qiyezhanghao">
