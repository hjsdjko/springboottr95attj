		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.zixunwenti" label="咨询问题" prop="zixunwenti">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zixunwenti"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zixunwenti = this.ruleForm.zixunwenti.replace(reg,'../../../springboottr95attj/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
